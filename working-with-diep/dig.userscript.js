...
const LAST_MODIFIED = '000';
const BUILD = '000';

const SAMPLES = 000;
const JUMP_TABLE_ADD = 000;
const JUMP_TABLE_VAL1 = 000 + JUMP_TABLE_ADD;
const JUMP_TABLE_VAL2 = 000 + JUMP_TABLE_ADD;
const JUMP_TABLE_VAL3 = 000 + JUMP_TABLE_ADD;
const JUMP_TABLE_VAL4 = 000 + JUMP_TABLE_ADD;
const JUMP_TABLE_LIM1 = 000;
const JUMP_TABLE_LIM2 = 000;
const JUMP_TABLE_LIM3 = 000;
const JUMP_TABLE_XOR  = 000;
const JUMP_TABLE_MUL  = 000;

const DECODE_FUNC = 000;
const DECODE_OFFSET_MAGIC_NUMBER = 000;
const DECODE_OFFSET_MAGIC_NUMBER_VAR = 000;
const DECODE_OFFSET_TABLE = 000;
const DECODE_OFFSET_TABLE_LOCATION = 000;
const DECODE_OFFSET_TABLE_LENGTH = 000;
const DECODE_OFFSET_JUMP_TABLE = 000 >> 2;

const ENCODE_FUNC = 000;
const ENCODE_OFFSET_MAGIC_NUMBER = 000;
const ENCODE_OFFSET_MAGIC_NUMBER_VAR = 000;
const ENCODE_OFFSET_TABLE = 000;
const ENCODE_OFFSET_TABLE_LOCATION = 000;
const ENCODE_OFFSET_TABLE_LENGTH = 000;
const ENCODE_OFFSET_JUMP_TABLE = 000 >> 2;
